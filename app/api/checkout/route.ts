...
export const dynamic = "force-dynamic"; // Força a rota a ser renderizada dinamicamente
...
export const POST = async (req: Request) => {
  try {
    ...
    const cartId = cartItems.cartItems?.cartItems[0]?.id
      ? cartItems.cartItems?.cartItems[0]?.id
      : "";
